...
create table exhibitions (
    ...
    ow_id NUMBER(10) CONSTRAINT ow_name_fk REFERENCES owners(ow_id)
);
...
CREATE TABLE arts_exhibition (
    ...
    art_price FLOAT,
    ex_id NUMBER(10) CONSTRAINT arts_ex_id_fk REFERENCES exhibitions(ex_id)
);
...
CREATE table asa (
    ...
    art_id NUMBER(10) CONSTRAINT art_asa_id_fk REFERENCES arts_customer(art_id),
    st_id NUMBER(10) CONSTRAINT st_id_fk REFERENCES staffs(st_id)
);
...
CREATE TABLE arts_customer (
    ...
    art_title VARCHAR2(20),
    art_price FLOAT,
    cus_id NUMBER(10) CONSTRAINT art_cus_id_fk REFERENCES customers(cus_id)
);
...
CREATE TABLE arts_artist (
    ...
    art_title VARCHAR2(20),
    art_price FLOAT,
    atst_id NUMBER(10) CONSTRAINT atst_id_fk REFERENCES artists(atst_id)
);
...
CREATE TABLE staffs (
    ...
    st_role VARCHAR2(20),
    st_name VARCHAR2(20),
    ow_id NUMBER(10) CONSTRAINT ow_id_fk REFERENCES owners(ow_id)
);